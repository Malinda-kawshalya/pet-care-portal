...
export function AdminApplicationsPanel() {
  ...
  return (
    <section className="space-y-5">
      <div className="rounded-3xl border border-[#d8deee] bg-white p-5 shadow-sm">
      ...
      <div className="space-y-5 max-h-[700px] overflow-y-auto">
        {loading ? (
          ...
          applications.map((application) => (
            <article key={application.id} className="rounded-3xl border border-[#d8deee] bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 grid gap-3 md:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl border border-[#edf2fb] bg-[#fafcff] p-4">
                  ...
                  <p className="mt-2 text-sm text-[#334155]">{application.email}</p>
                  <p className="text-sm text-[#334155]">{application.phoneNumber}</p>
                </div>
                <div className="rounded-2xl border border-[#edf2fb] bg-[#fafcff] p-4">
